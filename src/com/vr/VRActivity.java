...
public class VRActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener, Camera.PictureCallback, Camera.PreviewCallback, Camera.AutoFocusCallback {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        shotBtn = (Button) findViewById(R.id.TakePicture);
